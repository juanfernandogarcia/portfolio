...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action stays open so a swipe over a photo scrolls the gallery on
    // mobile; it is locked only while the slot is in reframe mode.
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '  <img part="image" alt="" draggable="false" fetchpriority="high" decoding="async" style="display:none">' +
